...
function findTripleInteger() {
  ...
  while (true) {
    ...
    const reversedNumber = moveLeastToMost(number);
...
function moveLeastToMost(num) {
  ...
  const result = leastSignificantDigit + withoutLeastSignificant;

  return parseInt(result);
}


const res = findTripleInteger();
